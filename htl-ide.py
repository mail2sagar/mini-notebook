...
open_btn = Button(window,image=open_img,text="Open",command=open)
open_btn.place(relx=0.05,rely=0.03,anchor=CENTER)

save_btn = Button(window,image=save_img,text="Save",command=save)
save_btn.place(relx=0.11,rely=0.03,anchor=CENTER)

exit_btn = Button(window,image=exit_img,text="Exit",command=close)
